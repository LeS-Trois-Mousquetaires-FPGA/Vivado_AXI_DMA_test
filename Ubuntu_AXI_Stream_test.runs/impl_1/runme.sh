...
HD_PWD='D:/Smart_ZYNQ_7010/Ubuntu_AXI_Stream_test/Ubuntu_AXI_Stream_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZYNQ_CORE_wrapper.tcl -notrace
