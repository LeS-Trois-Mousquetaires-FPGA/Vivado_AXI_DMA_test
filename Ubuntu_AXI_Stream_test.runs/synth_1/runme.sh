...
HD_PWD='D:/Smart_ZYNQ_7010/Ubuntu_AXI_Stream_test/Ubuntu_AXI_Stream_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_CORE_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_CORE_wrapper.tcl
